...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '27ef55356f3481fd9eb2f717b0e9b4ae,en:27ef55356f3481bbb44f000c2bebd793',
  THEME: process.env.NEXT_PUBLIC_THEME || 'gitbook', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
